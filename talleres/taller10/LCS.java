class LCS{
    ...
    public static void main(String args[]){
        ...
        String respuesta = lcsDP("AYZX", "AXYT");
        String respuestaInvertida = "";
        for (int x=respuesta.length()-1;x>=0;x--)
            respuestaInvertida = respuestaInvertida + respuesta.charAt(x);
        System.out.println(respuestaInvertida);
        }
 }
